...
/**
 * Represents an input message indicating a shelves request.
...
public class AskForAllShelves extends InputMessage implements Serializable {
    ...
    /**
     * Constructs a new AskForAllShelves object with the specified SerializableInput.
    ...
    /**
     * Executes the shelfTransferAll method on the provided Engine object.
     * @param engine the Engine object on which to perform the shelves request
